...
- (void)animateScore:(int)addedPoints {
    ...
    frm.origin.y = bottomBar.frame.origin.y;
    frm.origin.x = (topBar.frame.size.width - frm.size.width)/2.0;
    ...
    frm = score.frame;
    frm.origin.y = topBar.frame.origin.y + 1.25*topBar.frame.size.height;//score.frame.origin.y + score.frame.size.height - 0.25*frm.size.height;
    frm.origin.x = (topBar.frame.size.width - frm.size.width)/2.0;// score.frame.origin.x;// - 0.25*frm.size.width;
...
- (void)initDisplay:(CGRect)viewFrame : (UIViewController*)rootViewCont {
 ...
 //   [rootView addSubview:scoreLabel];
  ...
  //  frm = CGRectMake(0.035*rootView.frame.size.width, 1, 0.25*rootView.frame.size.width, 0.05*rootView.frame.size.width);
    ...
    frm = CGRectMake(0.035*rootView.frame.size.width, 1, 0.25*rootView.frame.size.width, 0.0575*rootView.frame.size.width);
    
    frm.origin.y = rootView.frame.size.height - 3.05*frm.size.height;
    frm.origin.x = rootView.frame.size.width - 1.35*frm.size.width;
   ...
   // frm.origin.x = rootView.frame.size.width - frm.size.width - frm.origin.x;
    frm.origin.y += 1.05*frm.size.height;
...
- (void)setUpFloatPieces:(CGRect)pcFrm {
 ...
 // Bomb piece
    ...
    pcFrm.origin.x -= 1.75*(bottomBar.frame.size.width - (addPiece.frame.origin.x + addPiece.frame.size.width)) + pcFrm.size.width;
 ...
 // Nuke piece
    ...
    pcFrm.origin.x -= 1.25*pcFrm.size.width; //+ addPiece.frame.origin.x - (bombPiece.frame.origin.x + bombPiece.frame.size.width);
