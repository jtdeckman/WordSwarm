...
- (void)setUp:(CGRect)frame :(CGFloat)origy :(UIView*)rview {
 ...
 // Text Box 2 (larger box)
    ...
    textBox3 = [[UILabel alloc] initWithFrame: textBox2.frame];
    ...
    [textBox3 setFont:[UIFont fontWithName:@"Copperplate" size:0.45*FONT_FACT*textBox2.frame.size.height]];
    
    textBox3.textColor = textBox2.textColor;//[UIColor yellowColor];//[UIColor colorWithRed:0.9 green:0.2 blue:0.2 alpha:1.0];
